...
using Dfe.Edis.SourceAdapter.Ukrlp.WebJob.Functions;
...
namespace Dfe.Edis.SourceAdapter.Ukrlp.WebJob.UnitTests.FunctionsTests.TimedCheckForChangeTests
{
    public class WhenRunningSchedule
    {
